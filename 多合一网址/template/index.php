...
<head>
    ...
    <meta name="keywords" content="音乐搜索">
    <meta name="description" content="多站合一音乐播放器">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">HaoQi音乐搜索器</h2>
                <p class="am-text-center">多站合一音乐播放器</p>
            </header>
            <hr>
                ...
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 孤勇者 陈奕迅" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://haoqi7.github.io" target="_blank" rel="">返回博客</a>&nbsp;<a href="https://github.com/Haoqi7" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
